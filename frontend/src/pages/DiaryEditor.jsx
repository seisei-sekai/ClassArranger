...
export default function DiaryEditor() {
  ...
  const handleGetLlamaRecommendation = async () => {
    ...
    try {
      ...
      toast.success("Llama recommendation generated successfully!");
    } catch (error) {
      const errorMsg =
        ...
        <div className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="mb-6">
            ...
            >
              ...
              {loadingRecommendation ? "Generating..." : "Get Llama Writing Suggestion"}
            </button>
          </div>
